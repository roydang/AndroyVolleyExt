...
import kr.androy.volleyext.util.Assert;
import kr.androy.volleyext.util.IoUtils;
...
public class SimpleXmlRequest<T> extends AbstractConverterRequest<T> {
	...
	protected Response<T> parseNetworkResponse(NetworkResponse response) {
		Log.d("EXT", "parseNetworkResponse11");
		Log.d("EXT", "parseNetworkResponse12");
		Log.d("EXT", "parseNetworkResponse13");
