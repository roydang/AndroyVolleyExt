...
import static kr.androy.volleyext.mock.ListenerVerifier.*;
import static org.hamcrest.CoreMatchers.*;
import static org.junit.Assert.*;
import kr.androy.volleyext.mock.ErrorResponseHoldListener;
import kr.androy.volleyext.mock.MockExecutorDelivery;
import kr.androy.volleyext.mock.ResponseHoldListener;
...
public class JacksonRequestIntegrationTest {
	...
	public void responseShouldBeParsedWithUnknownProperties() throws Exception {
		...
		// When
		Request<Person> request = new JacksonRequest<Person>(url,
